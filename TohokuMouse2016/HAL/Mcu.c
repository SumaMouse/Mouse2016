...
//	MTU.TSTR.BIT.CST4 = 1;
	...
	S12AD.ADCSR.BYTE = 0x00;	// b0:EXTRG = 0
								// b1:TRGE = 0
								// b2,3:CKS = 00
								// b4:ADIE = 0
								// b6:ADCS = 0
	...
	S12AD.ADSSTR01.WORD = 0x1428;	//40state
	...
	PORT1.PODR.BIT.B6 = 0;		//WALL SENSOR FL ON/OFF
	PORT1.PODR.BIT.B7 = 0;		//WALL SENSOR LS ON/OFF
	...
	PORTB.PODR.BIT.B5 = 1;		//RSPI SS RIGHT ENC
	PORTE.PODR.BIT.B1 = 1;		//RSPI CLK
	PORTE.PODR.BIT.B3 = 0;		//RSPI DI
	PORTE.PODR.BIT.B2 = 1;		//RSPI DO
	PORTC.PODR.BIT.B4 = 1;		//RSPI SS LEFT ENC
	PORTC.PODR.BIT.B5 = 0;		//WALL SENSOR RS ON/OFF
	PORTC.PODR.BIT.B6 = 0;		//WALL SENSOR FR ON/OFF
	PORTC.PODR.BIT.B7 = 0;		//MOTOR SLEEP

	PORT1.PDR.BIT.B5 = 1;		//RIGHT MOTOR CW/CCW
	PORT1.PDR.BIT.B6 = 1;		//WALL SENSOR FL ON/OFF
	PORT1.PDR.BIT.B7 = 1;		//WALL SENSOR LS ON/OFF
	...
	PORTB.PDR.BIT.B5 = 1;		//RSPI SS RIGHT ENC
	PORTE.PDR.BIT.B1 = 1;		//RSPI CLK
	PORTE.PDR.BIT.B3 = 0;		//RSPI DI
	PORTE.PDR.BIT.B2 = 1;		//RSPI DO
	PORTC.PDR.BIT.B4 = 1;		//RSPI SS LEFT ENC
	PORTC.PDR.BIT.B5 = 1;		//WALL SENSOR RS ON/OFF
	PORTC.PDR.BIT.B6 = 1;		//WALL SENSOR FR ON/OFF
	...
	MPC.P40PFS.BIT.ASEL = 1;	//WALL SENSOR FL AD
	MPC.P41PFS.BIT.ASEL = 1;	//WALL SENSOR LS AD
	MPC.P42PFS.BIT.ASEL = 1;	//WALL SENSOR RS AD
	MPC.P46PFS.BIT.ASEL = 1;	//WALL SENSOR FR AD
	...
	MPC.PE4PFS.BIT.ASEL = 1;	//BATTERY AD
